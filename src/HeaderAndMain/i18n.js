...
const resources = {
  en: {
    translation: {
      ...
      brandText: "The accumulated experience, well-coordinated team, and know-how allow us to be sure that every element manufactured under the TANKINOX brand will be of high quality.",
      ...
      ourProducts: 'OUR PRODUCTS',
        weldingPage: {
          title: "Welding | TANKINOX",
          title1: "Welding Services",
          services: {
            title: "TANKINOX provides professional industrial welding services:",
          ...
          mig: {
            ...
            migAdvantages: "Why choose MIG/MAG welding by TANKINOX:",
      ...
      TechnologiesTankinox: "TECHNOLOGIES AT TANKINOX",
      ...
      equipment: {
        ...
        methods: {
          ...
          subtitle: "from TANKINOX:"
        },
        cards: {
          card1: {
            title: "Production",
            highlight: "at TANKINOX factory",
        ...
        info: {
          title: "Why choose us?",
          description: "TANKINOX guarantees top-quality equipment and services tailored to your unique needs. With state-of-the-art technology and a highly skilled team, we ensure reliable and efficient production."
        }
      },
      ...
      item: {
        ...
        tankinox_info_part_1: "TANKINOX designs and manufactures process equipment strictly according to technical specifications and the client’s specific project. We approach every project with attention to detail, ensuring that our solutions are always customized and never standardized.",
      ...
      services11: "Tankinox specialize ",
      aboutPage: {
        title: "About us | TANKINOX"
      },
      ...
      productFirst: {
        ...
        rightDescription: "TANKINOX produces custom-made non-standard equipment, considering operational conditions.",
      ...
      cuttingPage: {
        ...
        title: "Cutting and Stamping | TANKINOX",
        mainTitle: "TANKINOX offers a wide range of metal processing services:",
      ...
      whatsapp: "WhatsApp: @Tankinox",
        thermal: {
          ...
          description: "It is impossible to meet the necessary standards and requirements without high-quality thermal insulation of tanks. You can order thermal insulation services for storage, heat exchange equipment, and pipelines at TANKINOX!",
          materials: "TANKINOX performs thermal insulation work with the following materials:",
          materialsList: {
  ...
  ru: {
    translation: {
      ...
      weldingPage: {
        ...
        services: {
          title: "TANKINOX предоставляет профессиональные услуги промышленной сварки:",
        ...
        mig: {
          ...
          migAdvantages: "Почему выбирают MIG/MAG сварку от TANKINOX:",
      ...
      services11: "Tankinox специализируется ",
      services11span: "на оптимизации производства, ",
      services11nospan: "что включает в себя полный спектр услуг:",
      brandText: "Накопленный опыт, слаженная команда и ноу-хау позволяют нам быть уверенными, что каждый элемент, изготовленный под брендом TANKINOX, будет высокого качества.",
      ...
      equipment: {
        ...
        methods: {
          ...
          subtitle: "от TANKINOX:"
        },
        cards: {
          card1: {
            title: "Производство",
            highlight: "на заводе TANKINOX",
        ...
        info: {
          ...
          description: "TANKINOX гарантирует высококачественное оборудование и услуги, адаптированные к вашим индивидуальным потребностям. С передовыми технологиями и высококвалифицированной командой мы обеспечиваем надежное и эффективное производство."
        }
      }, 
      ...
      lookingToTheFutureText: "С развитием отраслей развиваемся и мы. Tankinox продолжает расширять границы возможного в производстве емкостей, обеспечивая своим клиентам доступ к лучшим технологиям и наиболее надежным решениям на рынке.",
      ...
      TechnologiesTankinox: "ТЕХНОЛОГИИ В TANKINOX",
      ...
      productFirst: {
        ...
        title: "Каждый продукт Tankinox полностью настраиваем под отраслевые требования, с возможностями автоматизации, мониторинга и контроля температуры. Наши емкости созданы для долговечности, гигиены и оптимальной работы в различных приложениях.",
        ...
        rightDescription: "TANKINOX производит нестандартное оборудование, учитывая условия эксплуатации.",
        ...
        advantage1Description: "Благодаря технологии спиральной сварки TANKINOX производит инновационные емкости и контейнеры.",
      ...
      careers1: {
        ...
        joinTeam: "Присоединяйтесь к команде TANKINOX и станьте частью ведущей компании по производству нержавеющих емкостей.",
        whyWorkAtTankinox: "Почему нужно работать в Tankinox?",
    ...
    thermal: {
      ...
      materials: "TANKINOX проводит теплоизоляционные работы следующими материалами:",
      materialsList: {
      ...
      cladding: {
        title: "Обшивка в компании TANKINOX",
    ...
    cuttingPage: {
      ...
      title: 'Резка и Штамповка | TANKINOX',
      mainTitle: "TANKINOX предлагает широкий выбор услуг по металлообработке:",
  ...
  ro: {
    translation: {
      ...
      weldingPage: {
        ...
        services: {
          title: "TANKINOX oferă servicii profesionale de sudură industrială:",
        ...
        mig: {
          ...
          migAdvantages: "De ce să alegi sudura MIG/MAG de la TANKINOX:",
      ...
      equipment: {
        ...
        methods: {
          ...
          subtitle: "de la TANKINOX:"
        },
        cards: {
          card1: {
            title: "Producție",
            highlight: "la fabrica TANKINOX",
        ...
        info: {
          ...
          description: "TANKINOX garantează echipamente și servicii de cea mai înaltă calitate, adaptate la nevoile dumneavoastră. Cu tehnologie de ultimă generație și o echipă extrem de calificată, asigurăm o producție fiabilă și eficientă."
        }
      },      
      contacts: 'Contacte',
      language: 'Limbă',
      ...
      cuttingPage: {
        ...
        title: "Tăiere și Perforare | TANKINOX",
        mainTitle: "TANKINOX oferă o gamă largă de servicii de prelucrare a metalului:",
      ...
      item: {
        ...
        tankinox_info_part_1: "TANKINOX proiectează și produce echipamente pentru procese tehnologice, respectând cu strictețe specificațiile tehnice și proiectele individuale ale clienților. Abordăm fiecare proiect cu atenție la detalii, motiv pentru care soluțiile noastre sunt întotdeauna personalizate.",
      ...
      TechnologiesTankinox: "TEHNOLOGII LA TANKINOX",
      welding: "SUDURA",
      tankinox: {
        main: "TANKINOX GARANTEAZĂ ",
        span: "CALITATEA"
      },
      assembly: "MONTAJ",
      thermal: "TERMIC",
      ...
      thermal: {
        ...
        materials: "TANKINOX efectuează lucrări de izolare termică cu următoarele materiale:",
        materialsList: {
